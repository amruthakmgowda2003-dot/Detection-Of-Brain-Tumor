...
%*************** JPEG IMAGES ********************%
image1 = im2double(imread('D:\Glioblastoma\M-P20(CT).jpg'));
image1 = imresize(image1,[256 256]);
image1 = rgb2gray(image1);
image1 = im2bw(image1);
image2 = im2double(imread('D:\Glioblastoma\M-P20(MRI).jpg'));
...
output_file = sprintf('D:\\Glioblastoma\\outputs\\fused_image_M20.jpg');

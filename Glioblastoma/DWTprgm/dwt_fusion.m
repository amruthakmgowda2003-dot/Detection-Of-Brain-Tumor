...
%*************** JPEG IMAGES ********************%
image1 = im2double(imread('D:\Glioblastoma\p25(ct).jpg'));
image1 = imresize(image1,[256 256]);
image1 = rgb2gray(image1);
image1 = im2bw(image1);
image2 = im2double(imread('D:\Glioblastoma\p25(mri).jpg'));
...
output_file = sprintf('D:\\Glioblastoma\\outputs\\fused_image_25.jpg');
